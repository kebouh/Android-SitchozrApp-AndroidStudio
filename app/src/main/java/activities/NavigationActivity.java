   ...
   // private RelativeLayout mRelativeLayout;
    ...
    //    mRelativeLayout = (RelativeLayout) findViewById(R.id.relative_layout);
       ...
       // mDrawerLayout.add((ImageView)findViewById(R.id.icon));
        ...
        //navDrawerItems.add(new NavDrawerItem(navMenuTitles[4], navMenuIcons.getResourceId(3, -1), true, String.valueOf(Manager.getMatchProfiles().size())));
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[4], navMenuIcons.getResourceId(3, -1), true, /*String.valueOf(Manager.getMatchProfiles().size())*/"1"));
        // Pages
